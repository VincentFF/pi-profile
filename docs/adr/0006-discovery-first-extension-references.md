...
**Superseded by [ADR-0007](0007-pure-extension-runtime.md).** ADR-0007 removes extensions as a profile resource, so extension references, `resources.json`, `ResourceRegistry`, `dependsOn`, and `alwaysOn` no longer exist. Kept for history.
